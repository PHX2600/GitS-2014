using System;
using UnityEngine;
public class SnowMonster : Enemy
{
	private enum State
	{
		Dead,
	...
	private SnowMonster.State state;
	...
	private void Start()
	{
		this.state = SnowMonster.State.Idle;
	...
	private bool LookForPlayers()
	{
		...
		if (gameObject != null)
		{
			this.state = SnowMonster.State.RunToPlayer;
	...
	private void StartAttack()
	{
		...
		this.state = SnowMonster.State.Attack;
	...
	{
		this.state = SnowMonster.State.RandomWalk;
	...
	public override void UpdateAI()
	{
		...
		case SnowMonster.State.Idle:
			...
			break;
		case SnowMonster.State.RandomWalk:
			if (!this.LookForPlayers())
			{
				this.UpdateRandomWalk();
			}
			break;
		case SnowMonster.State.RunToPlayer:
			this.UpdateTargetedPlayer();
			break;
		case SnowMonster.State.Attack:
			this.UpdateAttack();
			break;
		}
	}
	public override void Die(GameObject killer)
	{
		...
		this.state = SnowMonster.State.Dead;
		base.Die(killer);
	}
